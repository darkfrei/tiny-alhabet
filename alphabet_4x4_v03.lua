...
--		table.insert (stream, bit)
	...
	if false or (neig_data.b > 0) and (neig_data.b2 < 3) and (neig_data.w > 0) and all_columns_and_rows (cells) then
		print ('[' .. num .. '] b:' .. neig_data.b .. ' b2:' .. neig_data.b2)
...
--		print (num)
		...
		save_to.bmp (s.."_"..num, {width=width, height=height, bit_per_pixel=bit_per_pixel}, {grayscale_stream = grayscale_stream, negative = true, x_reverse = false})
	end
end
